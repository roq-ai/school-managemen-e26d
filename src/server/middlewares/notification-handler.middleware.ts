...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'attendance.update': {
    roles: ['admin'],
    key: 'teacher-updated-attendance',
    tenantPath: ['school', 'attendance'],
    userPath: [],
  },
  'fee.update': { roles: ['admin'], key: 'accountant-updated-fees', tenantPath: ['school', 'fee'], userPath: [] },
  'exam.update': {
    roles: ['teacher', 'parent', 'student'],
    key: 'admin-updated-exam',
    tenantPath: ['school', 'exam'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['admin', 'teacher', 'accountant', 'parent', 'student'];
